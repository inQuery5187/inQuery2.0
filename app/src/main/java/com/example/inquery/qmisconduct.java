...
public class qmisconduct extends AppCompatActivity {
    ...
    String valAction, valApology, ID;
    private static final String SHARED_PREFS= "sharedPrefs";
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_qmisconduct);
        submit= findViewById(R.id.missubmit);
        dialog= findViewById(R.id.receiver);
        action= findViewById(R.id.rfrom);
        apology = findViewById(R.id.editTextTextMultiLine3);
            ...
            public void onClick(View view) {
                ...
                if(toAdd!=null){
                    ...
                    for(String str: toAdd){
                        db.child(str).child("misconduct").child("action").setValue(valAction);
                        db.child(str).child("misconduct").child("from").setValue(ID);
                        db.child(str).child("misconduct").child("apology").setValue(valApology);
                    }

                    Toast.makeText(qmisconduct.this, "Data submitted", Toast.LENGTH_SHORT).show();
                }
                else{
                    Toast.makeText(qmisconduct.this, "Please select the faculty", Toast.LENGTH_SHORT).show();
                }
            }
        ...
        dialog.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                AlertDialog.Builder mbuilder = new AlertDialog.Builder(qmisconduct.this);
